...
/// Service pour gérer les cartes OpenStreetMap dans l'app chauffeur
class OSMMapService {
  ...
  static Marker createDriverMarker(LatLng position, {double rotation = 0}) {
    return Marker(
      ...
      child: Transform.rotate(
        angle: rotation * (3.14159 / 180), // Convertir degrés en radians
        child: Icon(
          Icons.navigation,
          color: Colors.blue,
          size: 40,
  ...
  static TileLayer createTileLayer() {
    return TileLayer(
      ...
      userAgentPackageName: 'com.lebontaxi.drivers',
      maxZoom: 19,
      maxNativeZoom: 19,
